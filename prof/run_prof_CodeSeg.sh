...
for i in {1..8}; do
    ...
    cp ~/Grok/aiter/csrc/cpp_itfs/pa/Jacob/pa_kernels_${i}.cuh ~/Grok/aiter/csrc/cpp_itfs/pa/pa_kernels.cuh
    ...
    mv trace.rpd $out_folder/trace_bs${bs}_i256_o2048_${i}.rpd
    mv trace.csv $out_folder/trace_bs${bs}_i256_o2048_${i}.csv
done
