...
// __global__ __launch_bounds__(NUM_THREADS, 2) void paged_attention_ll4mi_QKV_mfma16_kernel( // Limit block number to 2
    ...
    const AttentionVariant* variant)
{
    ...
    {
        _paged_attention_kernel<scalar_t, cache_t, KV_DTYPE, BLOCK_SIZE, HEAD_SIZE, NUM_THREADS, ALIBI_ENABLED, GQA_RATIO, MTP, AttentionVariant>
