...
def compile(
    ...
    # print("[DEBUG] compile args\n"
    #     f"  gqa_ratio={gqa_ratio}\n"
    #     f"  head_size={head_size}\n"
    #     f"  npar_loops={npar_loops}\n"
    #     f"  dtype={dtype}\n"
    #     f"  kv_dtype={kv_dtype}\n"
    #     f"  fp8_kv_dtype={fp8_kv_dtype}\n"
    #     f"  out_dtype={out_dtype}\n"
    #     f"  block_size={block_size}\n"
    #     f"  alibi_enabled={alibi_enabled}\n"
...
def paged_attention_ragged(
    ...
    # print(f"[DEBUG] pa_ragged.py\n"
    #     f"  out.shape={out.shape}\n"
    #     f"  workspace_buffer.shape={workspace_buffer.shape}\n"
    #     f"  query.shape={query.shape}\n"
    #     f"  key_cache.shape={key_cache.shape}\n"
    #     f"  value_cache.shape={value_cache.shape}\n"
    #     f"  scale={scale}\n"
    #     f"  kv_indptr.shape={kv_indptr.shape}\n"
    #     f"  kv_page_indices.shape={kv_page_indices.shape}\n"
    #     f"  kv_last_page_lens.shape={kv_last_page_lens.shape}\n"
    #     f"  block_size={block_size}\n"
    #     f"  max_num_partitions={max_num_partitions}\n"
